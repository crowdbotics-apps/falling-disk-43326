"""
Django settings for falling_disk_43326 project.
...
ROOT_URLCONF = 'falling_disk_43326.urls'
...
WSGI_APPLICATION = 'falling_disk_43326.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_disk_43326 API",
    "DESCRIPTION": "API documentation for falling_disk_43326 App",
    "VERSION": "v1",
}
